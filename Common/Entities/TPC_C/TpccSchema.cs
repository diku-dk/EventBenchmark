...
namespace Common.Entities.TPC_C
{
    ...
    public class District
    {
        ...
        public District(int D_ID, int W_ID, string D_NAME, string D_STREET_1, string D_STREET_2, string D_CITY, string D_STATE, string D_ZIP, float D_TAX, float D_YTD, long D_NEXT_O_ID)
        {
            this.D_ID = D_ID;
            this.W_ID = W_ID;
            this.D_NAME = D_NAME;
