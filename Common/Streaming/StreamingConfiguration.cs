...
namespace Common.Streaming
{
    public class StreamingConfiguration
    {
         ...
         * APP
         */
        public static readonly Guid CustomerReactStreamId =   new("AD713788-B5AE-49FF-8B2C-F311B9CB0CC6");
        public static readonly Guid SellerReactStreamId   =   new("AD713788-B5AE-49FF-8B2C-F311B9CB0CC7");
