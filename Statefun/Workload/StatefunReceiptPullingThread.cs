...
public sealed class StatefunPollingThread 
{
    ...
    public StatefunPollingThread(string url, int rate, ICustomerService customerService, ISellerService sellerService, IDeliveryService deliveryService) {
        this.url = url;
        this.rate = rate;
